...
<body>
    ...
    <p>Kepada,<br>Yth. HRD Manager<br><b>{{ $industri }}</b><br>{{ $alamat_industri }}</p>

    <p>Menindaklanjuti informasi dari Bapak/Ibu, pada hari {{ $hari_ini }} tanggal {{ $tanggal_surat }} perihal
        penerimaan siswa kami untuk Prakerin di <b>{{ $industri }}</b>.</p>
    <p>Maka dengan ini kami kirimkan <b>{{ count($students) }} Orang</b> siswa sebagai berikut :</p>
    ...
    <p>Waktu pelaksanaan tanggal <b>{{ $actual_start }} s/d {{ $actual_end }}</b>, dengan catatan setiap hari Sabtu
    ...
    <table class="footer-table">
        <tr>
            <td style="width: 50%; text-align: left;">
                <p style="font-size: 10pt; margin: 0;">Contact Person:<br>{{ $pembimbing }}
                    ({{ $phone_pembimbing }})</p>
            </td>
